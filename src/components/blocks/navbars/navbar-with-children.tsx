...
const DesktopNav = ({ navItems }: any) => {
  ...
  return (
    <motion.div
      className={cn(
        "relative z-[60] mx-auto hidden w-full max-w-7xl flex-row items-center justify-between self-start rounded-full bg-white/50 px-4 py-2 lg:flex dark:bg-neutral-950/50",
  ...
  return (
    <>
      <motion.div
        ...
        key={String(open)}
        className="relative mx-auto flex w-full max-w-[calc(100vw-2rem)] flex-col items-center justify-between bg-white/50 px-4 py-2 lg:hidden dark:bg-neutral-950/50"
      >
        ...
        <AnimatePresence>
          {open && (
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="absolute inset-x-0 top-16 z-20 flex w-full flex-col items-start justify-start gap-4 rounded-lg bg-white/50 px-4 py-8 dark:bg-neutral-950/50"
            >
            ...
            <div className="absolute left-1/2 top-[calc(100%_+_0.2rem)] -translate-x-1/2 transform pt-4">
              <div className="">
                <motion.div
                  ...
                  className="mt-4 overflow-hidden rounded-2xl bg-white/50 shadow-xl backdrop-blur-sm dark:bg-neutral-950/50"
                >
                  <motion.div
...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative flex justify-center space-x-4 rounded-full bg-white/50 px-4 py-3 dark:bg-neutral-950/50"
    >
      {children}
    </nav>
  );
